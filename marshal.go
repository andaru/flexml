...
const (
	// Header is a generic XML header suitable for use with the output
	// of Marshal.  This is not automatically added to any output of
	// this package, it is provided as a convenience.
...
func (p *printer) tagName(name xml.Name) (string, bool) {
